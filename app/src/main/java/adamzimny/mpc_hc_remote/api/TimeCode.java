...
public class TimeCode implements Comparable<TimeCode> {
     ...
     * @throws TimeCodeException If minutes or seconds is larger than or equal to 60
     */
    ...
    public TimeCode(int seconds) throws TimeCodeException {
        ...
        seconds = seconds % 60;
        Log.d("timecode", hours + "h " + minutes + "m " + seconds + "s");
        init(hours, minutes, seconds);
    }
     ...
     *
     * @param timeCode The string representation of a time code
     * @throws TimeCodeException If the string is not a properly formatted time code
     */
     ...
     *
     * @param augend The first time code
     * @param addend The second time code
     ...
     * @throws TimeCodeException If the subtrahend is larger than the minuend
     */
